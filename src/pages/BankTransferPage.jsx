...
const BankAccountsPage = () => {
  ...
  const ethiopianBanks = [
    { id: 1, name: "Awash Bank", code: "AWASH", accountNumber: "01304611678000", accountName: "Atomic Educational Materials Supply P.L.C", logo: awash, color: "#1c7fe3ff", gradient: "linear-gradient(135deg, #e4edf3ff, #1d87f9ff)" },
    { id: 2, name: "Wegagen Bank", code: "WEGAGEN", accountNumber: "00789185005", accountName: "Atomic Educational Materials Supply P.L.C", logo: wegagen, color: "#f2780dff", gradient: "linear-gradient(135deg, #f67811ff, #e4ebeaff)" },
    { id: 3, name: "Bank of Abyssinia", code: "BOA", accountNumber: "72627218", accountName: "Atomic Educational Materials Supply P.L.C", logo: birhan, color: "#e8ef0dff", gradient: "linear-gradient(135deg, #c9b411ff, #bdd61cff)" },
    { id: 4, name: "Nib International Bank", code: "NIB", accountNumber: "2600160003769", accountName: "Atomic Educational Materials Supply P.L.C", logo: debub, color: "#FF6B35", gradient: "linear-gradient(135deg, #FF6B35, #FFA07A)" },
    { id: 5, name: "Zemen Bank", code: "ZEMEN", accountNumber: "144110376159012", accountName: "Atomic Educational Materials Supply P.L.C", logo: zemen, color: "#6A0572", gradient: "linear-gradient(135deg, #6A0572, #9D4EDD)" },
    { id: 6, name: "Dashen Bank", code: "DASHEN", accountNumber: "1252105861751", accountName: "Atomic Educational Materials Supply P.L.C", logo: dashen, color: "#118AB2", gradient: "linear-gradient(135deg, #118AB2, #06D6A0)" },
    { id: 7, name: "Commercial Bank of Ethiopia", code: "CBE", accountNumber: "1000123456789", accountName: "Atomic Educational Materials Supply P.L.C", logo: cbe, color: "#073B4C", gradient: "linear-gradient(135deg, #073B4C, #118AB2)" }
  ];
                ...
                <div className="bank-logo-container">
                  ...
                  >
                    <img 
                      src={bank.logo} 
                      alt={`${bank.name} logo`}
                      className="bank-logo hover-glow"
                      style={{ filter: "none" }}
                    />
                  </div>
                </div>
