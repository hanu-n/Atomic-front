    ...
    <div className="bank-accounts-page">
      ...
      <div className="accounts-header">
        ...
        <div className="header-content">
          ...
          <button className="not-found-btn me-1" onClick={() => navigate(-1)}>
            <span className="btn-icon">↩️</span>
            Go Back
          </button>
          <div className="company-badge">
      ...
      {/* ✅ New Row: Bank Logos Preview */}
      <div className="bank-logos-row">
        {ethiopianBanks.map((bank) => (
          <div key={bank.id} className="bank-logo-item" title={bank.name}>
        ...
        <div className="accounts-grid">
          {ethiopianBanks.map((bank) => (
            ...
            >
              ...
              <div className="bank-card-header">
                <div className="bank-logo-container">
                  <div className="logo-background" style={{ background: bank.gradient }}>
                    <img
                      src={bank.logo}
                      alt={`${bank.name} logo`}
              ...
              <div className="bank-color-accent" style={{ background: bank.gradient }}></div>
            </div>
          ))}
        </div>
        ...
        <div className="info-section">
          <div className="info-card">
            ...
            <div className="info-content">
              ...
              <ul className="info-list">
                <li>Use any of the above bank accounts for payments</li>
                <li>Save a screenshot of your receipt for verification</li>
                <li>Include your Order ID as reference if possible</li>
                <li>Contact support after making payment</li>
              </ul>
            </div>
          </div>
